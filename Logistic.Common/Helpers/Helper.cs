...
namespace Logistic.Common.Helpers
{
    ...
    public static class Helper
    {
        ...
        public static string GenerateAlphanumericCode(int longitud)
        {
            ...
            while (0 < longitud--)
            {
                int randomIndex = rnd.Next(allowedCharacters.Length);
        ...
        public static decimal GetDiscount(decimal total, int percentaje)
        {
            decimal discount = (total * percentaje) / 100;
